...
WorkableListController.template = "workable_connector.WorkableListView";
...
registry.category("views").add("workable_list_hiring_plan", workableListView);